...
import { getSupportStatusLabel } from "@shared/supportAvailability";
...
export default function Home() {
  ...
  useEffect(() => {
    const timer = window.setInterval(() => setSupportNow(new Date()), 30_000);
