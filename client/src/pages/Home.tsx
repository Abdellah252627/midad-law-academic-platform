...
import { calculateQuizScore, getQuizChapterAnchor, getQuizQuestionState, getQuizResultStatus, QUIZ_PASSING_PERCENTAGE, shuffleQuizQuestions, type QuizQuestion } from "@shared/quiz";
import {
  ArrowLeft,
  ArrowUpLeft,
  BookOpen,
