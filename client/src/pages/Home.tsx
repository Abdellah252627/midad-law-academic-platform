...
export default function Home() {
  ...
  const faqs = (landingQuery.data?.faqs?.length
    ...
    : fallbackFaqs.map(([question, answer]) => ({ question, answer, category: (question.includes("التحويل") || question.includes("الدفع") || question.includes("مراجعة الطلب") ? "payment" : question.includes("ملخص") || question.includes("فصل") || question.includes("تحديث") ? "content" : question.includes("طلب") || question.includes("سعر") ? "purchase" : "support") as FaqCategory }))).map(faq => {
