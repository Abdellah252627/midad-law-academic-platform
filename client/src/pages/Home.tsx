...
const fallbackFaqs = [
  ...
  ["كم تستغرق مراجعة الطلب؟", "تتم المراجعة بعد التحقق من وصول التحويل ووضوح بيانات الطلب. إذا تأخرت الحالة، أرسل رقم الطلب والبريد أو رقم واتساب المستخدم عبر صفحة الدعم أو واتساب لتسهيل المتابعة."],
