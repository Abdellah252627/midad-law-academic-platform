...
function AdminForumContent() {
  ...
  return <div dir="rtl" className="mx-auto max-w-6xl space-y-6">
    <header className="rounded-[28px] bg-[#173247] p-6 text-white shadow-sm sm:p-8"><p className="text-xs font-bold tracking-[0.18em] text-[#d5a15f]">MIDAD LAW / MODERATION</p><h1 className="mt-2 font-display text-3xl font-bold">إشراف المنتدى</h1><p className="mt-2 text-sm leading-7 text-white/75">راجع البلاغات المفتوحة واتخذ إجراءً تعليمياً متناسباً مع قواعد Midad Law.</p><Link href="/admin/forum/blocked-words" className="mt-4 inline-flex rounded-full bg-white/10 px-4 py-2 text-sm font-bold text-white transition hover:bg-white/20">إدارة الكلمات المسيئة</Link></header>
