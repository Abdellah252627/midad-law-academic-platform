...
function AdminDashboardContent() {
  ...
  const deleteChapter = trpc.admin.deleteChapter.useMutation({ onSuccess: () => { toast.success("تم حذف المعاينة"); utils.admin.landingContent.invalidate(contentInput); }, onError: error => toast.error(error.message) });
  const restoreChapter = trpc.admin.restoreChapter.useMutation({ onSuccess: () => { toast.success("تم استرجاع المعاينة"); utils.admin.landingContent.invalidate(contentInput); }, onError: error => toast.error(error.message) });
  ...
  const deleteFaq = trpc.admin.deleteFaq.useMutation({ onSuccess: () => { toast.success("تم حذف السؤال"); utils.admin.landingContent.invalidate(contentInput); }, onError: error => toast.error(error.message) });
  const restoreFaq = trpc.admin.restoreFaq.useMutation({ onSuccess: () => { toast.success("تم استرجاع السؤال"); utils.admin.landingContent.invalidate(contentInput); }, onError: error => toast.error(error.message) });
