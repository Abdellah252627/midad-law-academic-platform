...
function AdminDashboardContent() {
  ...
  return <div dir="rtl" className="mx-auto max-w-7xl space-y-6">
    <header className="rounded-[28px] bg-[#173247] p-6 text-white shadow-[0_20px_60px_rgba(23,50,71,0.16)] sm:p-8"><p className="text-xs font-bold tracking-[0.18em] text-[#d5a15f]">MIDAD / CONTROL CENTER</p><div className="mt-2 flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><h1 className="font-display text-3xl font-bold">إدارة صفحة الهبوط</h1><p className="mt-2 max-w-2xl text-sm leading-7 text-white/70">عدّل المحتوى والاختبارات من هنا ثم انشره للزوار. لا تظهر هذه الواجهة إلا لحسابات الإدارة.</p></div><div className="flex flex-wrap items-center gap-2"><Link href="/admin/follow-ups" className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-xs font-bold text-white transition hover:bg-white/20"><Headset className="h-4 w-4" aria-hidden="true" />طلبات التواصل</Link><Link href="/admin/preview" className="inline-flex items-center gap-2 rounded-full bg-[#d5a15f] px-4 py-2 text-xs font-bold text-[#173247] transition hover:bg-[#e2b875]">معاينة قبل النشر</Link><span className="rounded-full bg-white/10 px-4 py-2 text-xs font-bold">{productCode}</span></div></div></header>
