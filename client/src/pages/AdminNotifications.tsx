...
type NotificationType = "purchase_request" | "support_follow_up" | "complaint" | "system" | "forum_violation_threshold";
...
const typeMeta: Record<NotificationType, { label: string; className: string }> = {
  ...
  system: { label: "إشعار نظام", className: "bg-violet-50 text-violet-700" },
  forum_violation_threshold: { label: "مخالفة منتدى", className: "bg-orange-50 text-orange-700" },
};
